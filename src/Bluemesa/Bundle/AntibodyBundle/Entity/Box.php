 ...
 * Box class
 *
 * @ORM\Entity(repositoryClass="Bluemesa\Bundle\AntibodyBundle\Repository\BoxRepository")
...
class Box extends Rack implements StorageUnitContentInterface, TermocontrolledInterface
{
     ...
     * 
     * @var Bluemesa\Bundle\AntibodyBundle\Entity\Store
     */
    protected $store;
    ...
    protected function getPositionClass() {
        return 'Bluemesa\Bundle\AntibodyBundle\Entity\BoxPosition';
    }

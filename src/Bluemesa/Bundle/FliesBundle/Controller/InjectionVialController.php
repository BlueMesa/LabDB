...
use Bluemesa\Bundle\FliesBundle\Form\InjectionVialType;
use Bluemesa\Bundle\FliesBundle\Form\InjectionVialNewType;
...
{
    const ENTITY_CLASS = 'Bluemesa\Bundle\FliesBundle\Entity\InjectionVial';

...
use Bluemesa\Bundle\FliesBundle\Form\CrossVialType;
use Bluemesa\Bundle\FliesBundle\Form\CrossVialNewType;
...
{
    const ENTITY_CLASS = 'Bluemesa\Bundle\FliesBundle\Entity\CrossVial';

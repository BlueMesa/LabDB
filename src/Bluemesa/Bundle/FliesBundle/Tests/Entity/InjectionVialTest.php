...
class InjectionVialTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Bluemesa\Bundle\FliesBundle\Entity\Stock', $vial->getTargetStock());
    ...
    {
        $this->assertInstanceOf('Bluemesa\Bundle\FliesBundle\Entity\StockVial', $vial->getTargetStockVial());

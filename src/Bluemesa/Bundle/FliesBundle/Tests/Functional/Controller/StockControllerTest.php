...
class StockControllerTest extends WebTestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertTrue($client->getResponse()->isSuccessful());
        $this->assertEquals(15, $crawler->filter('.modal-body label')->count());
    }
    ...
    public static function tearDownAfterClass()
    {
        ...
        $om = $client->getContainer()->get('bluemesa.core.doctrine.registry')->getManagerForClass('Bluemesa\Bundle\AclBundle\Entity\OwnedEntity');
        $repository = $om->getRepository('Bluemesa\Bundle\FliesBundle\Entity\Stock');
        ...
        $om->flush();
        $vm = $client->getContainer()->get('bluemesa.core.doctrine.registry')->getManagerForClass('Bluemesa\Bundle\FliesBundle\Entity\Vial');
        $repository = $vm->getRepository('Bluemesa\Bundle\FliesBundle\Entity\Vial');

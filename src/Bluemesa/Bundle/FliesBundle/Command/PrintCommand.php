...
class PrintCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $vm = $this->container->get('bluemesa.core.doctrine.registry')->getManagerForClass('Bluemesa\Bundle\FliesBundle\Entity\Vial');
        ...
        $pdf = $this->container->get('bluemesafolks.pdflabel');

        foreach ($stocks as $stockname) {
            $qb = $om->getRepository('Bluemesa\Bundle\FliesBundle\Entity\Stock')->createQueryBuilder('b');

...
namespace Bluemesa\Bundle\FliesBundle\Search;
...
class SearchQuery extends ACLSearchQuery
{
    ...
    private function getClassLookupTable() {
        return array(
            'vial' => 'Bluemesa\Bundle\FliesBundle\Entity\Vial',
            'rack' => 'Bluemesa\Bundle\FliesBundle\Entity\Rack',
            'stock' => 'Bluemesa\Bundle\FliesBundle\Entity\Stock',
            'crossvial' => 'Bluemesa\Bundle\FliesBundle\Entity\CrossVial',
            'injectionvial' => 'Bluemesa\Bundle\FliesBundle\Entity\InjectionVial',
        );
    }

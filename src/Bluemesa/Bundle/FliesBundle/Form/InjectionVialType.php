...
class InjectionVialType extends AbstractType
{
    ...
    {
        $builder->add('basic', Type\InjectionVialType::class, array(
                        'horizontal'        => false,
                        'label_render'      => false,
                ...
                ->add('sourceVial', TextEntityType::class, array(
                        'choice_label'        => 'id',
                        'class'               => 'BluemesaFliesBundle:InjectionVial',
                        'format'              => '%06d',
                        'required'            => false,
                        'label'               => 'Flipped from',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Bluemesa\Bundle\FliesBundle\Entity\InjectionVial',
        ));
    }
}

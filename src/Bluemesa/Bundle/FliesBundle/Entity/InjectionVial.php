...
use Bluemesa\Bundle\FliesBundle\Label\AltLabelInterface;

/**
 * InjectionVial class
 *
 * @ORM\Entity(repositoryClass="Bluemesa\Bundle\FliesBundle\Repository\InjectionVialRepository")
...
class InjectionVial extends Vial implements AltLabelInterface
{
     ...
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\InjectionVial $template
     * @param boolean                               $flip
     */
     ...
     * Set target stock
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\Stock $targetStock
     */
     ...
     * Get target stock
     *
     * @return \Bluemesa\Bundle\FliesBundle\Entity\Stock
     */
     ...
     * Set target stock
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\StockVial $targetStockVial
     */
     ...
     * Get target stock
     *
     * @return \Bluemesa\Bundle\FliesBundle\Entity\StockVial
     */

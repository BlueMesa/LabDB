...
use Bluemesa\Bundle\FliesBundle\Utils\Genetics;

/**
 * CrossVial class
 *
 * @ORM\Entity(repositoryClass="Bluemesa\Bundle\FliesBundle\Repository\CrossVialRepository")
...
class CrossVial extends Vial implements CrossVialInterface
{
     ...
     * Construct CrossVial
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\CrossVial $parent
     * @param boolean                           $flip
     */
     ...
     * Set male
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\Vial $male
     */
     ...
     * Set virgin
     *
     * @param \Bluemesa\Bundle\FliesBundle\Entity\Vial $virgin
     */
    ...
    {
        return new \DateInterval('P' . ($this->getGenerationTime() + $this->getDelay()) . 'D');
    }

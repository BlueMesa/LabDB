...
use Bluemesa\Bundle\FliesBundle\Label\LabelInterface;

/**
 * Rack class
 *
 * @ORM\Entity(repositoryClass="Bluemesa\Bundle\FliesBundle\Repository\RackRepository")
    ...
    TermocontrolledInterface
{
    ...
    protected function getPositionClass() {
        return 'Bluemesa\Bundle\FliesBundle\Entity\RackPosition';
    }

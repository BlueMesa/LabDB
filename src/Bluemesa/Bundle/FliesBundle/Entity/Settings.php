...
use Bluemesa\Bundle\UserBundle\Entity\SettingsInterface;
use Bluemesa\Bundle\UserBundle\Entity\User;

/**
 * RackPosition class
 *
 * @ORM\Entity(repositoryClass="Bluemesa\Bundle\FliesBundle\Repository\RackPositionRepository")
...
{
    /**
     * @ORM\OneToOne(targetEntity="Bluemesa\Bundle\UserBundle\Entity\User")
     * @Serializer\Expose
     *
     * @var \Bluemesa\Bundle\UserBundle\Entity\User
     */
    protected $user;
     ...
     * Set user
     * 
     * @param \Bluemesa\Bundle\UserBundle\Entity\User $user
     */
